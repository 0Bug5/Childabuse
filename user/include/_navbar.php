            ...
            <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex justify-content-center">
                    <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                        <a class="navbar-brand brand-logo text-white" href="index.html"><i class="typcn typcn-user text-white"></i> USER</a>
                    ...
                    <ul class="navbar-nav mr-lg-2">
                        <li class="nav-item nav-profile dropdown">
                            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
                                ...
                                <span class="nav-profile-name"><span style="color: red; font-size:20px; font-weight:bold;">Welcome </span><?php echo $_SESSION['email'] ?></span>
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-right">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link" href="right.php">Abuse</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-complaint">
                                <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="complaint.php">Send Complaint</a></li>
                                <li class="nav-item"> <a class="nav-link" href="list.php">My Complaint</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
